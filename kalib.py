...
if selected == "🏠 Home":
    ...
    if st.session_state.syarat:
        ...
        st.session_state.ketelitian_lb = st.number_input("<'color:#00000;'>Masukkan Ketelitian Labu Takar (mL)", min_value=0.00, value=st.session_state.ketelitian_lb, step=0.0100, format="%.4f", unsafe_allow_html=True)
